# Inngest — Style Reference https://www.inngest.com/
...
### Design token
{
  "color": {
    "background-charcoal": {
      "$value": "#0c0a09",
      "$type": "color",
      "$description": "Background Charcoal — Page backgrounds, card surfaces, primary dark UI elements."
    },
    "surface-dark-gray": {
      "$value": "#1c1917",
      "$type": "color",
      "$description": "Surface Dark Gray — Elevated card surfaces, input fields, and slightly lighter dark UI elements."
    },
    "text-white": {
      "$value": "#ffffff",
      "$type": "color",
      "$description": "Text White — Primary text color for headlines and important body copy on dark backgrounds."
    },
    "text-light-gray": {
      "$value": "#f6f6f6",
      "$type": "color",
      "$description": "Text Light Gray — Secondary text and content on dark backgrounds, providing slightly less contrast."
    },
    "text-medium-gray": {
      "$value": "#a89984",
      "$type": "color",
      "$description": "Text Medium Gray — Tertiary text, subtle descriptions, and less prominent information."
    },
    "border-light-gray": {
      "$value": "#e5e7eb",
      "$type": "color",
      "$description": "Border Light Gray — Prominent borders, separators, and outlines on light backgrounds (if present) or as high-contrast separators on dark."
    },
    "border-accent-gray": {
      "$value": "#44403c",
      "$type": "color",
      "$description": "Border Accent Gray — Subtle borders and dividers within dark components, providing definition without distraction."
    },
    "amber-glow": {
      "$value": "#cab16a",
      "$type": "color",
      "$description": "Amber Glow — Primary accent for interactive elements, CTA buttons, active navigation, and key highlights – a warm counterpoint to the dark neutrals."
    },
    "highlight-green": {
      "$value": "#59a569",
      "$type": "color",
      "$description": "Highlight Green — Illustrative elements and secondary highlights."
    },
    "muted-red": {
      "$value": "#ea6962",
      "$type": "color",
      "$description": "Muted Red — Error states or distinctive highlights in content."
    },
    "vivid-orange": {
      "$value": "#cc5b33",
      "$type": "color",
      "$description": "Vivid Orange — Secondary brand accent; used sparingly for illustrative details."
    }
  },
  "font": {
    "circularxx": {
      "$value": "CircularXX",
      "$type": "fontFamily",
      "$description": "Primary content font for body text, navigation, and most interactive elements. Its modern, clean aesthetic provides clarity on dark backgrounds."
    },
    "circularxxmono": {
      "$value": "CircularXXMono",
      "$type": "fontFamily",
      "$description": "Monospace text for code snippets, technical labels, and distinct inline elements, indicating programmatic content."
    },
    "whyte": {
      "$value": "Whyte",
      "$type": "fontFamily",
      "$description": "Display headlines for large, impactful headings. Its distinct letterforms and tighter letter-spacing at larger sizes give headlines a condensed, authoritative presence."
    },
    "whyte-inktrap": {
      "$value": "Whyte Inktrap",
      "$type": "fontFamily",
      "$description": "Specialized body & headlines for emphasized text and headlines, providing a sharper, more technical edge in select areas."
    }
  },
  "typography": {
    "xs": {
    ...
    "4xl-2": {
      ...
      "$type": "typography",
      "$description": "Typography step 4xl-2 at 36px"
    },
    "4xl-3": {
      "$value": {
        "fontFamily": "Whyte Inktrap",
      ...
      "$type": "typography",
      "$description": "Typography step 4xl-3 at 36px"
    },
    "4xl-4": {
      "$value": {
        "fontFamily": "Whyte",
      ...
      "$type": "typography",
      "$description": "Typography step 4xl-4 at 36px"
    },
    "5xl": {
      "$value": {
        "fontFamily": "Whyte",
    ...
    "5xl-2": {
      ...
      "$type": "typography",
      "$description": "Typography step 5xl-2 at 48px"
    },
    "5xl-3": {
      "$value": {
        "fontFamily": "Whyte",
      ...
      "$type": "typography",
      "$description": "Typography step 5xl-3 at 48px"
    },
    "5xl-4": {
      "$value": {
        "fontFamily": "Whyte Inktrap",
      ...
      "$type": "typography",
      "$description": "Typography step 5xl-4 at 60px"
    },
    "5xl-5": {
      "$value": {
        "fontFamily": "CircularXX",
      ...
      "$type": "typography",
      "$description": "Typography step 5xl-5 at 72px"
    },
    "5xl-6": {
      "$value": {
        "fontFamily": "Whyte",
      ...
      "$type": "typography",
      "$description": "Typography step 5xl-6 at 72px"
    },
    "5xl-7": {
      "$value": {
        "fontFamily": "Whyte",
      ...
      "$type": "typography",
      "$description": "Typography step 5xl-7 at 72px"
    }
  },
  "spacing": {
    "8": {
  ...
  "shadow": {
    ...
    "subtle-2": {
      "$value": "rgba(0, 0, 0, 0.1) 0px 1px 3px 0px, rgba(0, 0, 0, 0.1) 0px 1px 2px -1px",
      "$type": "shadow",
      "$description": "Shadow elevation subtle-2"
    },
    "xl": {
      "$value": "rgba(0, 0, 0, 0.1) 0px 20px 25px -5px, rgba(0, 0, 0, 0.1) 0px 8px 10px -6px",
      "$type": "shadow",
  ...
  "$extensions": {
    "com.refero.extraction": {
      ...
      "siteName": "Inngest",
      "extractedAt": "2026-04-11T16:04:47.650Z",
      "variant": "extended"
    }
  }
}