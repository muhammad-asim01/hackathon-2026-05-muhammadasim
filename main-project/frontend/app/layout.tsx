...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    // og:image is auto-resolved from app/opengraph-image.tsx
  },
  twitter: {
    ...
    // twitter:image is auto-resolved from app/opengraph-image.tsx
  },
  icons: {
    // SVG icon — supported by all modern browsers, served from /public
    icon: [
      { url: "/favicon.svg", type: "image/svg+xml" },
      // PNG fallback generated by app/icon.tsx (32×32) — picked up automatically
      // by Next.js and served at /icon.png for browsers that prefer raster icons
    ],
